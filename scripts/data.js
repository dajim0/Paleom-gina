...
const scopeContents = {
  ...
  A1: {
    es: {
      ...
      content: "Hace unos 250 millones de años el mar de Tetis se extendió entre Gondwana y Laurasia: un océano mesozoico y cenozoico, somero, cálido y rico en arrecifes, amonites, bivalvos, lirios de mar y grandes reptiles marinos. El ámbito recorre su evolución con mapas de la Pangea y de Europa en cuatro hitos: Triásico (250 Ma), Jurásico (199 Ma), Cretácico (145 Ma) y Mioceno (23 Ma), señalando la Península Ibérica y Sierra Mágina. En el Triásico, Pangea se fractura y Tetis crece como golfo ecuatorial; en Jaén aparecen Nothosaurus, Henodus, Tanystropheus, Hybodus y Saurichthys (Siles, Villarrodrigo, Las Atalayas). En el Jurásico, Tetis separa Laurasia y Gondwana; destaca Hispaniachelys en Cazorla, plesiosaurios e ictiosaurios. En el Cretácico alcanza su máxima extensión: ammonites, belemnites y Steneosaurus (Bedmar). En el Mioceno se reduce hasta dejar el Mediterráneo, el Mar Negro y el Caspio; en la provincia documentan Megalodon (Porcuna), ballenas, Metaxytherium y otáridos (Villanueva de la Reina). Las huellas del arcosaurio de Cambil (Triásico superior) muestran fauna terrestre junto al litoral triásico.",
      timeline: "Triásico (250 Ma) · Jurásico (199 Ma) · Cretácico (145 Ma) · Mioceno (23 Ma)",
      related: "Conecta con el guion del vídeo n.º 2 del ámbito, la serie Del mar de Tetis a Sierra Mágina, el clip de ammonites cretácicos, el vídeo del Arcosaurio de Cambil, el glosario (Tetis, Pangea, Belemnite) y los modelos 3D de huellas.",
      facts: [
        "Explica por qué hay fósiles marinos en una sierra interior",
        ...
        "Mioceno: Megalodon, ballenas, sirénidos y otáridos; remanentes del Mediterráneo",
    ...
    en: {
      ...
      content: "About 250 million years ago the Tethys Ocean spread between Gondwana and Laurasia: a Mesozoic and Cenozoic sea, shallow, warm, and rich in reefs, ammonites, bivalves, sea lilies, and large marine reptiles. This scope follows its evolution with Pangea and European maps at four milestones: Triassic (250 Ma), Jurassic (199 Ma), Cretaceous (145 Ma), and Miocene (23 Ma), marking Iberia and Sierra Mágina. In the Triassic, Pangea breaks apart and the Tethys grows as an equatorial gulf; Jaén yields Nothosaurus, Henodus, Tanystropheus, Hybodus, and Saurichthys (Siles, Villarrodrigo, Las Atalayas). In the Jurassic the Tethys separates Laurasia and Gondwana; Hispaniachelys in Cazorla, plesiosaurs, and ichthyosaurs stand out. In the Cretaceous it reaches maximum extent: ammonites, belemnites, and Steneosaurus (Bedmar). In the Miocene it shrinks until only the Mediterranean, Black Sea, and Caspian remain; the province records Megalodon (Porcuna), whales, Metaxytherium, and pinnipeds (Villanueva de la Reina). Cambil's archosaur footprints (Late Triassic) show terrestrial fauna near the Triassic shoreline.",
      timeline: "Triassic (250 Ma) · Jurassic (199 Ma) · Cretaceous (145 Ma) · Miocene (23 Ma)",
      related: "Connects with scope video script no. 2, the From the Tethys Sea to Sierra Mágina series, the Cretaceous ammonite clip, the Cambil archosaur video, glossary entries (Tethys, Pangea, Belemnite), and 3D footprint models.",
      facts: [
        ...
        "Miocene: Megalodon, whales, sirenians, pinnipeds; Mediterranean remnants",
...
const glossary = {
  ...
  en: [
    ...
    { term: "Triassic", category: "Geology", def: "First period of the Mesozoic, beginning about 252 million years ago. At Paleomágina it is linked to shoreline environments and archosaur footprints at Cambil." },
...
const scopeDescriptions = {
  es: {
    ...
    scope_a5: "Paleolítico superior y relato de Mágina (~13.000 años).",
  ...
  en: {
    ...
    scope_a5: "Upper Paleolithic and Mágina's story (~13,000 years ago).",
...
const translations = {
  es: {
    ...
    dino_3d_disclaimer: "Los dinosaurios mostrados son representaciones genéricas; las huellas fósiles enlazan con el registro triásico de Cambil y ayudan a interpretar rastros, no esqueletos.",
  ...
  en: {
    ...
    dino_3d_lead: "Select a dinosaur or fossil. The archosaur footprints connect Cambil's Triassic record with the Tethys Sea scope.",
    dino_3d_hint: "Choose a model to rotate and zoom. Generic representation for educational purposes.",
    dino_3d_disclaimer: "The dinosaurs shown are generic representations; the fossil footprints link to Cambil's Triassic record and help interpret traces, not skeletons.",
