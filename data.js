...
const scopeContents = {
  ...
  A0: {
    es: {
      ...
      facts: ["Presenta el relato general del centro","Introduce cómo usar paneles, QR y audiovisuales","Sitúa Sierra Mágina como archivo geológico y humano"]
    },
    en: {
  ...
  A5: {
    es: {
      ...
      related: "En esta página, audiovisuales y recursos didácticos amplían el arte y la tecnología lítica de este ámbito.",
  ...
  A8: {
    es: {
      ...
      related: "Conecta con recursos, audiovisuales y glosario para mostrar cómo se construye el conocimiento.",
  ...
  A9: {
    es: {
      ...
      related: "Los audiovisuales de esta página recogen voces de investigación y memoria territorial enlazadas con este cierre del recorrido.",
...
const glossary = {
  es: [
    ...
    { term: "Subtítulos", category: "Museografía", def: "Texto sincronizado con audiovisuales. Mejora accesibilidad, comprensión bilingüe y consulta de contenidos sonoros." },
...
const translations = {
  es: {
    ...
    nav_home: "Inicio", nav_about: "Sobre el museo", nav_exhibits: "Ambitos",
    ...
    img_museo_moderno_alt: "Interior del centro de interpretación Paleomagina",
    ...
    img_exterior_museo_alt: "Exterior del Museo Paleomagina",
    ...
    resources_more_after_text: "Audiovisuales, vocabulario científico y materiales de consulta para continuar el aprendizaje.",
    resources_more_after_cta: "Ver audiovisuales",
    ...
    glossary_context_intro: "Este glosario no funciona como un diccionario aislado: acompaña el recorrido por ámbitos, la línea temporal, el mapa interactivo y los audiovisuales. Las categorías de arriba organizan los términos; aquí explicamos qué aporta cada bloque al proyecto Paleomágina.",
    ...
    glossary_guide_paleo_p2: "Esta categoría enlaza con ámbitos como el mar de Tetis, el Cuaternario y la reconstrucción paleoambiental que aparece en paneles y audiovisuales.",
    ...
    av_planned_badge: "Serie Paleomagina",
    ...
    route_rec_detail_2: "Paneles, objetos y audiovisuales de acogida presentan Sierra Mágina y preparan la secuencia de ámbitos de la planta primera.",
    ...
    route_resources_detail_2: "Audiovisuales y recursos digitales amplían temas complejos del recorrido: tiempo geológico, procesos naturales y modos de vida.",
    ...
    route_exp_detail_3: "Tras la visita, esta web conserva mapa, línea temporal, glosario y audiovisuales para consulta posterior.",
  ...
  en: {
    ...
    nav_home: "Home", nav_about: "About the museum", nav_exhibits: "Exhibits",
    ...
    img_museo_moderno_alt: "Interior of the Paleomagina interpretation centre",
    ...
    img_exterior_museo_alt: "Exterior of the Paleomagina Museum",
    ...
    resources_more_after_text: "Audiovisuals, scientific vocabulary, and reference material to continue learning.",
    resources_more_after_cta: "View audiovisuals",
    ...
    page_exhibits_title: "Paleomagina | Exhibits", page_resources_title: "Paleomagina | Hours",
    ...
    av_planned_badge: "Paleomagina series",
