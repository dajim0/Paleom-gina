...
const translations = {
  es: {
    ...
    track_characters_lead: "Pulsa cada animal o fósil para ver qué pistas deja: dientes, dieta, huellas y restos fósiles.",
    track_char_archosaur_name: "Arcosaurio de Cambil",
    track_char_archosaur_tag: "Carnívoro",
    track_char_archosaur_badge: "Carnívoro",
    track_char_archosaur_trait_1: "Dientes puntiagudos",
    track_char_archosaur_trait_2: "Huella tridáctila con garras",
    track_char_archosaur_trait_3: "Restos fósiles de depredador",
    track_char_archosaur_bubble: "Los dientes afilados y las huellas estrechas indican dieta carnívora.",
    track_char_raptor_name: "Terópodo de Santisteban",
    track_char_raptor_tag: "Cazador bípedo",
    track_char_raptor_badge: "Cazador",
    track_char_raptor_trait_1: "Pisada ligera de tres dedos",
    track_char_raptor_trait_2: "Garras para atrapar presas",
    track_char_raptor_trait_3: "Relacionado con el misterio del huevo",
    track_char_raptor_bubble: "Un depredador bípedo deja huellas recientes y profundas cuando corre o caza.",
    track_char_herbivore_name: "Herbívoro robusto",
    track_char_herbivore_tag: "Planta y pisada pesada",
    track_char_herbivore_badge: "Herbívoro",
    track_char_herbivore_trait_1: "Dientes anchos para moler",
    track_char_herbivore_trait_2: "Huella ancha y pesada",
    track_char_herbivore_trait_3: "Cráneos y pisadas de animales pacíficos",
    track_char_herbivore_bubble: "Los dientes planos y las huellas anchas apuntan a alimentación vegetal.",
    track_trace_path_title: "De rastro a fósil",
    track_trace_path_lead: "Un animal deja una acción. Si esa acción se conserva en la roca, se convierte en una pista fósil o icnita.",
    track_trace_step_1_action: "Acción: caminar",
    track_trace_step_1_fossil: "Icnita: huella",
    track_trace_step_1_title: "Huella de paso",
    track_trace_step_1_text: "Caminar sobre barro deja una pisada que puede fosilizarse como icnita.",
    track_trace_step_2_action: "Acción: alimentarse",
    track_trace_step_2_fossil: "Fósil: coprolito",
    track_trace_step_2_title: "Coprolito",
    track_trace_step_2_text: "Un excremento fosilizado conserva una acción de alimentación y digestión.",
    track_trace_step_3_action: "Acción: excavar",
    track_trace_step_3_fossil: "Icnita: túnel",
    track_trace_step_3_title: "Galería excavada",
    track_trace_step_3_text: "Un animal excava un túnel; el paso se conserva como icnita en la roca.",
    ...
    track_training_title: "Clasifica las evidencias",
    track_training_lead: "El reto es sencillo: selecciona una imagen, mira la evidencia destacada y pulsa la interpretación que explique mejor lo que ves.",
  ...
  en: {
    ...
    track_characters_lead: "Tap each animal or fossil to see the clues it leaves: teeth, diet, footprints, and fossil remains.",
    track_char_archosaur_name: "Cambil archosaur",
    track_char_archosaur_tag: "Carnivore",
    track_char_archosaur_badge: "Carnivore",
    track_char_archosaur_trait_1: "Pointed teeth",
    track_char_archosaur_trait_2: "Three-toed footprint with claws",
    track_char_archosaur_trait_3: "Predator fossil remains",
    track_char_archosaur_bubble: "Sharp teeth and narrow tracks point to a carnivorous diet.",
    track_char_raptor_name: "Santisteban theropod",
    track_char_raptor_tag: "Bipedal hunter",
    track_char_raptor_badge: "Hunter",
    track_char_raptor_trait_1: "Light three-toed step",
    track_char_raptor_trait_2: "Claws to catch prey",
    track_char_raptor_trait_3: "Linked to the egg mystery",
    track_char_raptor_bubble: "A bipedal predator leaves deep, recent tracks when running or hunting.",
    track_char_herbivore_name: "Robust herbivore",
    track_char_herbivore_tag: "Plants and heavy steps",
    track_char_herbivore_badge: "Herbivore",
    track_char_herbivore_trait_1: "Broad grinding teeth",
    track_char_herbivore_trait_2: "Wide, heavy footprint",
    track_char_herbivore_trait_3: "Skulls and tracks of peaceful animals",
    track_char_herbivore_bubble: "Flat teeth and broad tracks point to plant feeding.",
    track_trace_path_title: "From trace to fossil",
    track_trace_path_lead: "An animal leaves an action. If that action is preserved in rock, it becomes a fossil clue or ichnite.",
    track_trace_step_1_action: "Action: walking",
    track_trace_step_1_fossil: "Ichnite: footprint",
    track_trace_step_1_title: "Footprint",
    track_trace_step_1_text: "Walking on mud leaves a step that can fossilise as an ichnite.",
    track_trace_step_2_action: "Action: feeding",
    track_trace_step_2_fossil: "Fossil: coprolite",
    track_trace_step_2_title: "Coprolite",
    track_trace_step_2_text: "A fossilised dropping preserves feeding and digestion.",
    ...
    track_trace_step_3_text: "An animal digs a tunnel; the behaviour is preserved as an ichnite in rock.",
    ...
    track_training_title: "Classify the evidence",
    track_training_lead: "The challenge is simple: select an image, check the highlighted evidence, and press the interpretation that best explains what you see.",
