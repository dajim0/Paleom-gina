...
// ── Mapa territorial Sierra Mágina (coordenadas % sobre silueta) ─────
...
const translations = {
  es: {
    ...
    territory_map_title: "Sierra Mágina en el territorio",
    territory_map_lead: "Puntos de interés vinculados al relato del museo. Pulsa un marcador para abrir el ámbito correspondiente en el recorrido.",
    territory_map_aria: "Mapa esquemático de Sierra Mágina con puntos seleccionables",
    territory_map_hint: "Selecciona un punto del mapa o de la lista.",
  ...
  en: {
    ...
    territory_map_title: "Sierra Mágina in the territory",
    territory_map_lead: "Points of interest linked to the museum narrative. Tap a marker to open the matching scope in the exhibition route.",
    territory_map_aria: "Schematic map of Sierra Mágina with selectable points",
    territory_map_hint: "Select a point on the map or in the list.",
